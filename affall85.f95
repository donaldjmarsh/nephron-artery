	...
	integer :: lout(25),ntime,iprint,ncount,bpcount
	...
	real(kind=8) :: startprt,stoptime,prtstart(3),timestop(3)
	real(kind=8) :: res0,pressGlom(50),rasAff(10),affRad(50,2)
	...
	real(kind=8) :: zsum,psum 
        ...
        real(kind=8) :: rootpress,pressNod(25), nodediff(9) ,nodeadd(9),nodemeandiff(9)
        real*8 kr(2)/1.0D-13,0.50D-13 /
        real(kind=8) ::  res=2.0D-02
        real(kind=8) :: varphi=1.8D-02
        real(kind=8) :: vartheta=1.0D-02
        real(kind=8) :: gcc(10)
!        real(kind=8) :: artgRad(9)
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
      ...
      end subroutine NODEDELTA
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!      
      SUBROUTINE NODECHECK(mcount)
        ...
        end subroutine NODECHECK
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
        SUBROUTINE AVRADCHECK(kcount)

          implicit NONE

          integer :: i,kcount
          do i = 1,10;avrad(i) = avrad(i)/dble(kcount);enddo
            

        return

        end subroutine AVRADCHECK  
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
        end module
