...
!  Initialize time and counters.
	...
	jcount=jcount+1
        ...
        if (myid == 0) then
           ...
           rbf(1)=2.D0*bufRecv1(1)
           rbf(2)=2.D0*bufRecv2(1)
           rbf(3)=2.D0*bufRecv3(1)
           rbf(4)=2.D0*bufRecv4(1)
           rbf(5)=2.D0*bufRecv5(1)
           rbf(6)=2.D0*bufRecv6(1)
           rbf(7)=2.D0*bufRecv7(1)
           rbf(8)=2.D0*bufRecv8(1)
           rbf(9)=2.D0*bufRecv9(1)
           rbf(10)=2.D0*bufRecv10(1)
