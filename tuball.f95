...
!  read system wide parameters
	...
	open (unit=22,file='inputsys.dat')
        ...
        read (22,*) prtstart(1),timestop(1),prtstart(2),timestop(2) ,gnef,xgi,g0,inr,jobno

	write (*,'(//)')
        write (*,'(x,2(A9,2x,A9,2x),3x,A4,7x,A2,9x,A3,5x,A5)') na1, &
             na2,na3,na4,na6,na9,na5,na7
        write (*,'(D9.2,6(2x,D9.2),2x,I5)') (prtstart(i),timestop(i),i=1,2), &
                          gnef,xgi,g0,jobno
...
!  reads initial values for  myogenic model
        ...
        double precision :: deltat, xint, yint, betax
